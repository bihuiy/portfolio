    ...
    <div className="experience">
      ...
      <div className="experience-item">
        <div className="experience-line-one">
          ...
          <div className="experience-time">2025</div>
        </div>
      ...
      <div className="experience-item">
        <div className="experience-line-one">
          <div className="experience-role">Junior Project Manager</div>
          <div className="experience-time">Dec 2019 - Sep 2024</div>
        </div>
        <div className="experience-line-two">
          <div>Efiniti Telecommunications</div>
      ...
      <div className="experience-item">
        <div className="experience-line-one">
          <div className="experience-role">IT Support Intern</div>
          <div className="experience-time">Sep 2019 - Dec 2019</div>
        </div>
        <div className="experience-line-two">
          <div>EnerSys</div>
